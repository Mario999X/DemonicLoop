...
public class LibraryStates : MonoBehaviour
{
    ...
    // A�adimos los estados a los al personaje que se lo aplique 
    ...
    public void AddState(GameObject target, string state)
    {
        if (states.ContainsKey(state.ToUpper()))
        {
            ...
            // Comprobamos la vida y calcula el da�o que le aplicara
            ...
            {
                // Calcula el da�o y si se excede la salud del personaje se estable a 1
